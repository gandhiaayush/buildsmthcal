...
> **Documentation-First Rule:** Before writing code touching any external API, library, or SDK not yet verified this session — look up current docs first. See `CLAUDE.md` for the full rule and per-API list.
